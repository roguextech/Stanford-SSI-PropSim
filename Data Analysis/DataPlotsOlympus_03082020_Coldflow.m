...
data_fuel = readtable("../Test Data/2020_03_08_Coldflow.csv");
data_ox = readtable("../Test Data/2020_03_08_Coldflow.csv");

% Time offsets
fuel_start_time = 1665.7;
ox_start_time = 1800.4;
test_duration = 6.5;

time_fuel = data_fuel.Channel8*1e-3 - fuel_start_time;
time_ox = data_ox.Channel8*1e-3 - ox_start_time;
pft = data_fuel.Channel4*psi_to_Pa; % Pressure Fuel Tank
pot = data_ox.Channel5*psi_to_Pa; % Pressure Ox Tank
pos = data_ox.Channel2*psi_to_Pa; % Pressure Ox Supply
pom = data_ox.Channel6*psi_to_Pa; % Pressure Ox Supply
...
pft_start = 540*psi_to_Pa; % psi, after valve open
pft_shutoff = 243*psi_to_Pa; % psi
dm_fuel = 1.05e-3*rho_fuel; % fuel mass expended, kg
