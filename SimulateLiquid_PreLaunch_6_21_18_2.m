...
atm_to_Pa = 101325; % 1 atm in Paz
L_to_m3 = 1e-3; % 1 L in m^3


%% Options
test_data.test_plots_on = 1; % Import tests data and plot against simulation data
test_data.test_data_file = '6_14_2019.mat'; % File from which to import test data
...
%Injector Exit Area
inputs.ox.injector_area = 28.5*1.1*mm_to_m^2;
inputs.fuel.injector_area = 2.61*mm_to_m^2;
...
gammaaaa = inputs.fuel_pressurant.gas_properties.gamma
inputs.fuel_pressurant.set_pressure = (755+50)*psi_to_Pa;
