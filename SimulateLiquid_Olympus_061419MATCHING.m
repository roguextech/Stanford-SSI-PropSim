...
test_data.test_data_file = '6_14_2019_squeeze.mat'; % File from which to import test data
test_data.t_offset = -2032.8; % Time offset of test data wrt simulation data [s]
...
inputs.fuel.injector_area = 1.88*mm_to_m^2;
